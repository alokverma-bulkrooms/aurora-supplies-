...
const QRSection = () => {
  return (
    <div className="bg-gradient-to-br from-slate-50 to-green-50/30 py-20">
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-green-100/50 overflow-hidden backdrop-blur-sm">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="hidden lg:flex bg-gradient-to-br from-green-50/80 to-emerald-50/60 p-12 flex-col items-center justify-center relative">
              ...
              {/* QR Code */}
              <div className="bg-white p-8 rounded-2xl shadow-xl border-2 border-green-200/50 mb-8 relative z-10 hover:shadow-2xl transition-all duration-300">
                <img 
              ...
              <a 
                ...
                className="bg-gradient-to-r from-[#25D366] to-[#128C7E] hover:from-[#128C7E] hover:to-[#25D366] text-white px-8 py-4 rounded-full font-semibold inline-flex items-center space-x-3 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-green-500/50 relative z-10"
              >
