        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-12 flex flex-col items-center justify-center">
              ...
              {/* Frame Text */}
              <div className="bg-[#25D366] text-white px-6 py-3 rounded-full font-semibold">
            ...
            <div className="p-12 flex flex-col justify-center">
              <div className="mb-8">
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
                  Connect with our expert team instantly through WhatsApp for quick quotes, 
              ...
              <div className="space-y-4">
                <a 
                  ...
                  className="inline-flex items-center justify-center space-x-3 bg-[#25D366] hover:bg-[#128C7E] text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-green-500/25 w-full sm:w-auto"
                >
