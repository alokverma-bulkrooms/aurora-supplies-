      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl shadow-2xl border border-green-100/50 overflow-hidden backdrop-blur-sm">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="hidden lg:flex bg-gradient-to-br from-green-50/80 to-emerald-50/60 p-10 xl:p-12 flex-col items-center justify-center relative">
              {/* Decorative elements */}
              ...
              {/* QR Code */}
              <div className="bg-white p-6 xl:p-8 rounded-2xl shadow-xl border-2 border-green-200/50 mb-6 relative z-10 hover:shadow-2xl transition-all duration-300">
                <img 
                  src="/lovable-uploads/94c87f1c-bbd6-4dd8-8a19-325238fb12d1.png" 
                  alt="WhatsApp QR Code" 
                  className="w-40 h-40 xl:w-48 xl:h-48 object-contain"
                />
              </div>
            </div>
            
            {/* Right side - Content - Full width on mobile/tablet */}
            <div className="p-8 sm:p-10 xl:p-12 flex flex-col justify-center bg-gradient-to-br from-white to-gray-50/50 lg:col-span-1 col-span-1">
              
              <div className="mb-8">
                <p className="text-gray-700 text-xl sm:text-2xl xl:text-3xl leading-relaxed lg:mb-12 mb-8 font-medium">
                  Revolutionizing global trade with intelligence through an AI-powered platform.
                </p>
                
                {/* Steps to get quotes */}
                <div className="space-y-4 mb-8">
                  <h3 className="text-xl xl:text-2xl font-semibold text-gray-800 mb-4">How to Get Your Quote:</h3>
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3 text-gray-700">
                      <div className="w-8 h-8 xl:w-10 xl:h-10 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full flex items-center justify-center">
                        <Smartphone className="w-4 h-4 xl:w-5 xl:h-5" />
                      </div>
                      <span className="text-base xl:text-lg">Scan QR code or click the WhatsApp button</span>
                    </div>
                    <div className="flex items-center space-x-3 text-gray-700">
                      <div className="w-8 h-8 xl:w-10 xl:h-10 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full flex items-center justify-center">
                        <FileText className="w-4 h-4 xl:w-5 xl:h-5" />
                      </div>
                      <span className="text-base xl:text-lg">Share your requirements</span>
                    </div>
                    <div className="flex items-center space-x-3 text-gray-700">
                      <div className="w-8 h-8 xl:w-10 xl:h-10 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full flex items-center justify-center">
                        <Clock className="w-4 h-4 xl:w-5 xl:h-5" />
                      </div>
                      <span className="text-base xl:text-lg">Receive your personalized quote within 24-48 hours</span>
                    </div>
                  </div>
                </div>
