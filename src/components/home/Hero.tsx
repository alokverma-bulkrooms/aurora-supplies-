          ...
          <div className="text-black space-y-6 lg:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <a 
                ...
                className="group bg-gradient-to-r from-green-400 to-green-300 hover:from-green-300 hover:to-green-200 text-white px-6 lg:px-8 py-3 lg:py-4 rounded-xl font-semibold text-base lg:text-lg shadow-2xl hover:shadow-green-300/50 transform hover:scale-105 transition-all duration-300"
              >
                Get Instant Quote
              </a>
              <button className="group border-2 border-green-300 text-green-300 hover:bg-green-300 hover:text-white px-6 lg:px-8 py-3 lg:py-4 rounded-xl font-semibold text-base lg:text-lg transition-all duration-300">
                Watch Demo
              </button>
            </div>
          </div>
