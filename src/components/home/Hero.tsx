          ...
          <div className="text-white space-y-8">
            <div className="space-y-6">
              <div className="space-y-2">
                <div className="inline-flex items-center px-4 py-2 bg-green-500/20 rounded-full border border-green-400/30 backdrop-blur-sm">
                  <Globe2 className="w-4 h-4 mr-2 text-green-400" />
                  <span className="text-sm text-green-200">Global AI Trading Platform</span>
                </div>
              ...
              <div className="h-20 flex items-center">
                <h2 className="text-2xl lg:text-3xl text-green-200 font-medium">
                  {currentText}
            ...
            <div className="grid grid-cols-3 gap-6 py-8">
              <div className="text-center bg-white/5 rounded-xl p-4 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300">
                <div className="flex items-center justify-center mb-2">
                  <Globe2 className="w-6 h-6 text-green-400 mr-2" />
              ...
              <div className="text-center bg-white/5 rounded-xl p-4 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300">
                <div className="flex items-center justify-center mb-2">
                  ...
                  <div className="text-3xl font-bold text-emerald-400">24-48</div>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="group bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-2xl hover:shadow-green-500/50 transform hover:scale-105 transition-all duration-300 relative overflow-hidden">
              ...
              <button className="group border-2 border-green-400 text-green-400 hover:bg-green-400 hover:text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 relative overflow-hidden">
